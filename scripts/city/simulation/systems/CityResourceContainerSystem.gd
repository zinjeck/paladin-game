...
static func get_city_object_unreserved_storage_free_space(
	...
	return get_city_object_unreserved_storage_free_space_for_city_state(
...
static func set_city_object_stored_resource_amount(
	...
	return set_city_object_stored_resource_amount_for_city_state(
		_get_compatibility_city_state(),
		object_id,
		resource,
		amount,
...
static func add_resource_to_city_object_storage(
	...
	return add_resource_to_city_object_storage_for_city_state(
		_get_compatibility_city_state(),
		object_id,
		resource,
		amount_delta,
...
static func add_resource_bundle_to_city_object_storage(
	...
	return add_resource_bundle_to_city_object_storage_for_city_state(
		_get_compatibility_city_state(),
		object_id,
		requested_resources
	)
...
static func remove_resource_from_city_object_storage(
	...
	return remove_resource_from_city_object_storage_for_city_state(
		_get_compatibility_city_state(),
		object_id,
		resource,
		requested_amount,
