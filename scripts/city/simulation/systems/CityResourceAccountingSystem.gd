...
# for one explicit CITY settlement. Physical quantities remain authoritative in completed
...
static func get_city_container_version_for_city_state(
	...
	return state.container_version if state != null else -1
...
static func get_city_public_storage_version_for_city_state(
	...
	var state := get_state_for_city_state(city_state)
	return state.public_storage_version if state != null else -1
...
static func get_total_public_city_resource_amount_for_city_state(
	...
	return _get_total_public_city_resource_amount_from_objects(
		CityObjectSystem.get_city_objects_for_city_state(city_state),
		resource
	)


static func _get_total_public_city_resource_amount_from_objects(
	city_objects: Array,
	resource: String
) -> int:
	var total := 0
...
static func get_total_public_city_resource_storage_capacity_for_city_state(
	...
	return _get_total_public_city_resource_storage_capacity_from_objects(
		CityObjectSystem.get_city_objects_for_city_state(city_state),
		resource
	)


static func _get_total_public_city_resource_storage_capacity_from_objects(
	city_objects: Array,
	resource: String
) -> int:
...
static func get_total_stored_city_resource_amount_for_city_state(
	...
	return _get_total_stored_city_resource_amount_from_objects(
		CityObjectSystem.get_city_objects_for_city_state(city_state),
		resource
	)


static func _get_total_stored_city_resource_amount_from_objects(
	city_objects: Array,
	resource: String
) -> int:
	var total_amount := 0
...
static func get_total_owned_city_resource_amount_for_city_state(
	...
	return maxi(
		int(
			get_total_owned_city_resource_amounts_for_city_state(city_state).get(
				resource,
				0
			)
		),
...
static func _get_total_owned_city_resource_amounts(
	...
	var city_objects: Array = CityObjectSystem.get_city_objects_for_city_state(
		city_state
	)
	for raw_city_object in city_objects:
		if not raw_city_object is Dictionary:
...
static func get_total_city_resource_storage_capacity_for_city_state(
	...
	return _get_total_city_resource_storage_capacity_from_objects(
		CityObjectSystem.get_city_objects_for_city_state(city_state),
		resource
	)


static func _get_total_city_resource_storage_capacity_from_objects(
	city_objects: Array,
	resource: String
) -> int:
	var total_capacity := 0
