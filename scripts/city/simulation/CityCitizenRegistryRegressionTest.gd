...
func _test_add_rebuild_remove_and_reset_integrity() -> void:
	...
	var first := _add_citizen(culture_id)
	var second := _add_citizen(culture_id)
	var third := _add_citizen(culture_id)
	_expect(
	...
	var fourth := _add_citizen(culture_id)
	_expect(
	...
	var reused_first := _add_citizen(culture_id)
	_expect(
